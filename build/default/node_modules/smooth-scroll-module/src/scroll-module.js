export default class {
  ...
  scrollTo(target, instant = false) {
    ...
    this.duration = instant ? 0 : this.settings.duration; // The promise will resolve when the scroll has reached its endpoint.
  ...
  _loop(time, resolve) {
    ...
    if (this.timeElapsed < this.duration) requestAnimationFrame(time => this._loop(time, resolve));else this._end(resolve);
