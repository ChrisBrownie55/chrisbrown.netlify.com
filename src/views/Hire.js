...
const Hire = () => (
  <section className="hire">
    ...
    <form accept-charset="utf-8" action="https://usebasin.com/f/a8eea5a304e0" method="post" onReset={reset}>
      <ThemedInput label="Name *" placeholder="Josephine Smalls" type="text" name="name" aria-required="true" required="true" auto-validate></ThemedInput>
